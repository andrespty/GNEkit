...
from solvers.dgbne_solver.BayesianPlayer import BayesianPlayer, bayesian_players_to_list

class BayesianAlgorithm(ABC):
    def __init__(self,
                 obj_funcs: List[ObjFunction],
                 constraints: List[ConsFunction],
                 player_list: List[BayesianPlayer],
                 validate = True
                 ):
        validate_player_list(player_list, BayesianPlayer)
        player_info = bayesian_players_to_list(player_list)
        ...
        # Checking that each function returns scalar
        ...
        # Making sure that the indices provided are within range
        validate_player_functions(player_list, self.obj_functions, self.const, BayesianPlayer)
        ...
        self.player_types = player_info["types"]
